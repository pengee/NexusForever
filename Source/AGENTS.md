...
Infrastructure projects (`Shared`, `GameTable`, `IO`, `Cryptography`) and Aspire orchestration projects (`Aspire.AppHost`, `Aspire.Database.Migrations`) are covered by the build instructions in this file and do not have separate AGENTS.md files.